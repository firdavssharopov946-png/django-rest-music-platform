...
from api.user.serializers import music_serializers
...
class MusicListApiView(ListAPIView):
    ...
    serializer_class = music_serializers.MusicListSerializers
    permission_classes = [IsAuthenticated]


class MusicCreateAPIView(CreateAPIView):
    queryset = Music.objects.all()
    serializer_class = music_serializers.MusicCreateSerializers
    permission_classes = [IsAuthenticated]
